...
namespace Duck.Cameras.Windows.Controls
{
    ...
    public class Spinner : Control
    {
        ...
        public Spinner()
        {
            ...
            BackColor = Theme.Colors.SpinnerBgColor;
        ...
        [Browsable(true)]
        [Category("Appearance")]
        public Color NodeFillColor { get; set; } = Theme.Colors.SpinnerNodeFillColor;

        [Browsable(true)]
        [Category("Appearance")]
        public Color NodeBorderColor { get; set; } = Theme.Colors.SpinnerNodeBorderColor;
